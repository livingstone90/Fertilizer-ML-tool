...
export let TypeDescriptionContext = /*@__PURE__*/ (() => {
    class TypeDescriptionContext extends Base {
        constructor(a, b) {
            super();
            this.o = new Dictionary$2(String_$type, Base.$, 0);
            this.n = new Dictionary$2(String_$type, Delegate_$type, 0);
            this.f = null;
            this.h = 0;
            this.p = new HashSet$1(Dictionary$2.$.specialize(String_$type, String_$type), 0);
            this.f = a;
            this.h = b;
        }
        y(a) {
