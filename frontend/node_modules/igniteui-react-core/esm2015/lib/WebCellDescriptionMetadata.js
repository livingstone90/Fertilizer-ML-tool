 ...
 * @hidden
 */
export let WebCellDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebCellDescriptionMetadata extends Base {
        static b(a) {
        ...
        static d(a) {
            ...
            a.aa("WebCell", () => new WebCellDescription());
            a.z("WebCell", WebCellDescriptionMetadata.a);
        }
    }
    WebCellDescriptionMetadata.$t = /*@__PURE__*/ markType(WebCellDescriptionMetadata, 'WebCellDescriptionMetadata');
