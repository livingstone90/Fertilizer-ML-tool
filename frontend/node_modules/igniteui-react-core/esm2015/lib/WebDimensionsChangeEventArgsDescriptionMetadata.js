...
export let WebDimensionsChangeEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebDimensionsChangeEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.j(WebDimensionsChangeEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.y(WebDimensionsChangeEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.aa("WebDimensionsChangeEventArgs", () => new WebDimensionsChangeEventArgsDescription());
            a.z("WebDimensionsChangeEventArgs", WebDimensionsChangeEventArgsDescriptionMetadata.a);
        }
    }
    WebDimensionsChangeEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebDimensionsChangeEventArgsDescriptionMetadata, 'WebDimensionsChangeEventArgsDescriptionMetadata');
