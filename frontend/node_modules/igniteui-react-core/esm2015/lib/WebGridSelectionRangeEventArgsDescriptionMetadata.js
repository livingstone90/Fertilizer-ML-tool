...
export let WebGridSelectionRangeEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebGridSelectionRangeEventArgsDescriptionMetadata extends Base {
        ...
        static d(a) {
            ...
            a.aa("WebGridSelectionRangeEventArgs", () => new WebGridSelectionRangeEventArgsDescription());
            a.z("WebGridSelectionRangeEventArgs", WebGridSelectionRangeEventArgsDescriptionMetadata.a);
        }
    }
    WebGridSelectionRangeEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebGridSelectionRangeEventArgsDescriptionMetadata, 'WebGridSelectionRangeEventArgsDescriptionMetadata');
