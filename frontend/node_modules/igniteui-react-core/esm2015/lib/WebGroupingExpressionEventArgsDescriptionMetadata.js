...
export let WebGroupingExpressionEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class WebGroupingExpressionEventArgsDescriptionMetadata extends Base {
        ...
        static d(a) {
            ...
            a.aa("WebGroupingExpressionEventArgs", () => new WebGroupingExpressionEventArgsDescription());
            a.z("WebGroupingExpressionEventArgs", WebGroupingExpressionEventArgsDescriptionMetadata.a);
        }
    }
    WebGroupingExpressionEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(WebGroupingExpressionEventArgsDescriptionMetadata, 'WebGroupingExpressionEventArgsDescriptionMetadata');
