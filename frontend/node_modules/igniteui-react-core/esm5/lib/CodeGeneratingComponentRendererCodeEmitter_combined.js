...
var ReactMarkupCodeGeneratingComponentRendererCodeEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ReactMarkupCodeGeneratingComponentRendererCodeEmitter.prototype.bm = function () {
        var a = CodeGeneratingComponentRenderer.d1(stringReplace(stringReplace(this.ak, this.a0, ""), "Component", ""));
        a = this.k.u(a);
        return a;
    };
...
var TSCodeGeneratingComponentRendererDataEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    TSCodeGeneratingComponentRendererDataEmitter.prototype.an = function (a, b, c) {
        if (c.d) {
            return a.d + "_" + CodeGeneratingComponentRenderer.d2(this.u(b)) + "Item[]";
        }
        else if (c.f) {
    ...
    TSCodeGeneratingComponentRendererDataEmitter.prototype.ap = function (a, b, c, d, e) {
        ...
        if (typeCast(JsonDictionaryArray.$, d) !== null) {
            ...
            for (var i = 0; i < b.length; i++) {
                ...
                e.j(this.u(j) + ": ");
                if (k.d) {
                    var l = a + "_" + CodeGeneratingComponentRenderer.d2(this.u(j)) + "Item";
                    this.ap(l, k.a, k.b, h.item(j), e);
                }
                else if (k.f) {
                    var m = a + "_" + CodeGeneratingComponentRenderer.d2(this.u(j));
    ...
    CodeGeneratingComponentRenderer.prototype.emitCode = function (a) {
        ...
        try {
            for (var _h = __values(fromEnum(this.a5.keys)), _j = _h.next(); !_j.done; _j = _h.next()) {
                var g = _j.value;
                var h = g;
                h.c(this.context, b, this, this.dt);
            }
        }
        catch (e_13_1) {
            e_13 = { error: e_13_1 };
