...
var CodeGeneratingComponentRendererModuleEmitter = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CodeGeneratingComponentRendererModuleEmitter.prototype.n = function (a, b) {
        var _this = this;
        this.p();
        if (typeCast(JsonDictionaryArray.$, a) !== null) {
            ...
            var _loop_1 = function (d) {
                ...
                if (typeCast(JsonDictionaryValue.$, e) !== null) {
                    var f = e;
                    if (f != null) {
                        var g_1 = f.value.toString();
                        var h_1;
                        g_1 = ((function () { var i = _this.l(g_1, b, h_1); h_1 = i.p2; return i.ret; })());
                        this_1.m(b, g_1, h_1);
                    }
                }
            };
    ...
    CodeGeneratingComponentRendererModuleEmitter.prototype.l = function (a, b, c) {
        c = false;
    ...
    CodeGeneratingComponentRendererModuleEmitter.prototype.m = function (a, b, c) {
    };
    CodeGeneratingComponentRendererModuleEmitter.prototype.p = function () {
    };
