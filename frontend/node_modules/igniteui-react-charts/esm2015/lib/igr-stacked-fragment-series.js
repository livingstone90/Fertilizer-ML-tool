...
*/
    ...
    */
    getSeriesValueBoundingBox(world) {
        let iv = this.i.k5(toPoint(world));
        return fromRect(iv);
    }
    /**
    ...
    */
    ...
    getSeriesHighValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.kx(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    ...
    getSeriesValuePositionFromSeriesPixel(mouse, useInterpolation, skipUnknowns) {
        let iv = this.i.k2(toPoint(mouse), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    ...
    */
    toWorldPosition(seriesPoint) {
        let iv = this.i.k3(toPoint(seriesPoint));
        return fromPoint(iv);
    }
    /**
