...
export let DataLegendView = /*@__PURE__*/ (() => {
    class DataLegendView extends Base {
        constructor(a) {
            ...
            this.v = false;
            this.y = new List$1(FrameworkElement.$, 0);
            this.af = 0;
            this.f = null;
            this.h = null;
            this.g = null;
            ...
            this.q = ((() => {
                ...
                $ret.activate = runOn(this, this.ba);
                $ret.disactivate = runOn(this, this.bc);
                $ret.destroy = runOn(this, this.bb);
                return $ret;
            })());
            this.s = ((() => {
                let $ret = new Pool$1(TextBlock.$);
                $ret.create = runOn(this, this.bn);
                $ret.activate = runOn(this, this.bg);
                $ret.disactivate = runOn(this, this.bi);
                $ret.destroy = runOn(this, this.bh);
                return $ret;
            })());
            this.r = ((() => {
                let $ret = new Pool$1(TextBlock.$);
                $ret.create = runOn(this, this.bm);
                $ret.activate = runOn(this, this.bd);
                $ret.disactivate = runOn(this, this.bf);
                $ret.destroy = runOn(this, this.be);
                return $ret;
            })());
            this.p = ((() => {
                let $ret = new Pool$1(ContentControl.$);
                $ret.create = runOn(this, this.bj);
                $ret.activate = runOn(this, this.ay);
                $ret.disactivate = runOn(this, this.a0);
                $ret.destroy = runOn(this, this.az);
                return $ret;
            })());
            this.o = ((() => {
                let $ret = new Pool$1(TextBlock.$);
                $ret.create = runOn(this, this.bk);
                $ret.activate = runOn(this, this.av);
                $ret.disactivate = runOn(this, this.ax);
                $ret.destroy = runOn(this, this.aw);
                return $ret;
            })());
            this.z = new List$1(TextBlock.$, 0);
        ...
        a7(a, b) {
            ...
            c.passID = "LegendItem";
            for (let d = 0; d < this.aa.count; d++) {
                let e = this.aa._inner[d];
                if (e == null) {
                    continue;
                }
                let f = e.ah;
        ...
        ag(a) {
            ...
            let c = FontUtil.getCurrentFontHeight(this.ah, a);
        ...
        an() {
            for (let a = 0; a < this.y.count; a++) {
                this.af = Math.max(this.af, this.y._inner[a].ah);
            }
            if (this.af > 0) {
                for (let b = 0; b < this.y.count; b++) {
