...
export class IgrFinancialSeries extends IgrSeries {
    ...
    */
    ...
    set xAxis(v) {
        ...
        v == null ? this.i.qg = null : this.i.qg = v.i;
    }
    /**
    ...
    */
    ...
    set transitionInMode(v) {
        this.i.qr = ensureEnum(CategoryTransitionInMode_$type, v);
    }
    /**
    ...
    */
    ...
    getSeriesCloseValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.r8(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesOpenValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.r9(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesVolumeValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sa(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    ...
    getSeriesOpenValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.to(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesCloseValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.tn(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesVolumeValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.tp(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    /**
