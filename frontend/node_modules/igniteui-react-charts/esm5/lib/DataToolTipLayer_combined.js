...
var DataToolTipLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    DataToolTipLayer.prototype.get_db = function () {
        return true;
    };
    ...
    DataToolTipLayer.prototype.r4 = function () {
        ...
        if (e != null) {
            try {
                for (var _b = __values(fromEnum(e.da())), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var f = _c.value;
                    if (!f.dc && !f.ed) {
                        a = false;
                    }
    ...
    DataToolTipLayer.prototype.s5 = function (a) {
        ...
        try {
            for (var _b = __values(fromEnum(a.dd)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
                b.add(c);
            }
        }
    ...
    DataToolTipLayer.prototype.rk = function () {
        ...
        try {
            for (var _c = __values(fromEnum(this.cd.series)), _d = _c.next(); !_d.done; _d = _c.next()) {
                var a = _d.value;
                if (a.dh) {
                    var b = a.ar();
                    if (b != null && b.cn()) {
        ...
        try {
            for (var _e = __values(fromEnum(this.cd.series)), _f = _e.next(); !_f.done; _f = _e.next()) {
                var c = _f.value;
                if (!c.dh) {
                    var d = c.ag();
    ...
    DataToolTipLayer.prototype.rw = function () {
        ...
        try {
            for (var _b = __values(fromEnum(e.dd)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var f = _c.value;
                if (f.di) {
                    a = true;
                }
    ...
    DataToolTipLayer.prototype.r0 = function () {
        ...
        try {
            for (var _b = __values(fromEnum(d.da())), _c = _b.next(); !_c.done; _c = _b.next()) {
                var e = _c.value;
                if (e.isVertical) {
                    a = true;
                }
